...
import com.hoffmanshf.recommendation.request.CategoryCreateRequest;
...
public class CategoryController {
    ...
    @AdminPermission
    public String create(@Valid CategoryCreateRequest categoryCreateReq, BindingResult bindingResult) throws BusinessException {
